...
build-linux:
	...
	gh release upload v0.0.0 /tmp/hop-linux-x64.tar.gz --clobber
	gh release upload v0.0.0 /tmp/hop-linux-x64.zip --clobber
...
build-mac-x64:
	...
	gh release upload v0.0.0 /tmp/hop-macos-x64.tar.gz --clobber
	gh release upload v0.0.0 /tmp/hop-macos-x64.zip --clobber
...
build-mac-arch64:
	...
	gh release upload v0.0.0 /tmp/hop-macos-apple-silicon.tar.gz --clobber
	gh release upload v0.0.0 /tmp/hop-macos-apple-silicon.zip --clobber